...
##  Coursera.org
## 
##	Exploratory Data Analysis - Course Project 1: solution 2
##
...
#	function: draw line graph of Global Active Power, with these features: color, y-label
plot_graph2 <- function(dt, color, title, yLabel) {
	with(dt, {    
		plot(date_time, Global_active_power, type="l", xlab="", ylab=yLabel)
	}) 
}
...
if(!check_data_file(nmFile)) {
	...
	plot_graph2(x, FG_COLOR, TITLE, Y_LABEL)
	dev.off()		# important!
